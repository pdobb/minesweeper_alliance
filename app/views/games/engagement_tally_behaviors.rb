...
# Games::EngagementTallyBehaviors mixes in View Model behaviors for objects that
# wrap {EngagementTally}, for displaying engagement tally details in the view
# template.
module Games::EngagementTallyBehaviors
